$(document).ready(function(){ 
    ...
    $('#tableFiltro').DataTable({ 
        ...
        'ajax':{
            ...
            'url': "http://132.247.147.17/~javiergv/controlAsistencia/usuario/asistenciasTodasConsultSubd", 
        },
        'columns': [ 
            { 'data': 'Fecha' }, 
            { 'data': 'nombre' }, 
    ...
    $('#tableHoy').DataTable({ 
        ...
        'ajax':{
            ...
            'url': "http://132.247.147.17/~javiergv/controlAsistencia/usuario/asistenciasHoyConsultSubd", 
        },
        'columns': [ 
            { 'data': 'Fecha' }, 
            { 'data': 'nombre' }, 
    ...
    $('#consulBtn').on('click', function(e){
        ...
        if(fechaInicio != '' && fechaFin !='' ){//--------------------------CON FECHA---------------------------------------
            ...
            $('#tableFiltro').DataTable({
                    ...
                    'ajax':{
                        'method': "POST",
                        'url': "http://132.247.147.17/~javiergv/controlAsistencia/usuario/asistenciasPorFechaConsultSubd", 
                        'data': {
