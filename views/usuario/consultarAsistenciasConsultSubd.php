...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <div style="width:90%;">
        <ul class="navbar-nav">
            ...
            <input type="text" value="<?=$_SESSION['consultasSubd']->nomArea?>" hidden id="nomArea">
            <input type="text" value="<?=$_SESSION['subdConsultasSubd']->idSubdireccion?>" hidden id="idSubd">
            <input type="text" value="<?=$_SESSION['subdConsultasSubd']->nomSubd?>" hidden id="nomSub">
        </ul> 
    </div>
...
<div class="content-wrapper">
        ...
        <div class="row  mt-1">
            <div class="col-md-12 col-lg-12 col-sm-12 text-center ">
                ...
                <a class="btn btn-app boton" id="consultFechas">
                    <i class="fas fa-sort-alpha-down"></i> <b>Todas y por Fechas</b>
                </a>
                <!-- --------------------------------------FIN Botones-------------------------------------------------------------------- -->
            </div>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <script src="<?=base_url?>assets/js/consultarAsistenciasConsulSubd.js"></script>
