...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <div style="width:8%;text-align:right;">
        <a href="<?=base_url?>usuario/bienvenida" style="margin-top:-99%;"><i class="fas fa-home" style="color:#0b5ed7; outline: 1.90px solid #0b5ed7; border-radius:35%;padding:3%;"></i></a>
    </div>
...
<div class="content-wrapper">
        ...
        <div class="row  mt-1">
            <div class="col-md-12 col-lg-12 col-sm-12 text-center ">
                ...
                <a class="btn btn-app boton" id="consultDepto">
                    <i class="fas fa-sort-alpha-down"></i> <b>Todas y Filtrar</b>
                </a>
                <!-- --------------------------------------FIN Botones-------------------------------------------------------------------- -->
            </div>
        </div>
    ...
    <div class="row mb-3 " id="divSelect">
        ...
        <div class="col-md-12 text-center" style="">
            ...
            <!--             <div class="col mb-3 " hidden id="divChecks"style="display:inline-block;width:80% ;outline: 1.5px solid midnightblue; padding:5px; border-radius:2.5%;">
                
                <input type="checkbox" id="filtrarPorFecha"> 
                <label for="filtrarPorFecha" style="color:midnightblue;"><small><b>Filtrar por Fecha</b></small></label>
                
                <input type="checkbox" id="filtrarPorDepto"> 
                <label for="filtrarPorDepto" style="color:midnightblue;"><small><b>Filtrar por Departamento</b></small></label>
            </div>  -->
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12" style="">
                    <div id="divFiltrar" style="" hidden>
                        <form id="formDepto" style="width:100%;">

                            <div style="display:inline-block;width:32%;">
                                <label for="fechaInicio"
                                    style="font-weight: normal !important;display:inline-block;">De:</label>
                                <input type="date" name="fechaInicio" id="fechaInicio" style="display:inline-block;">
                                <span hidden style="color:red;" id="spanFechaInicio">Seleccione fecha de inicio</span>

                                <label for="fechaFin"
                                    style="font-weight: normal !important;display:inline-block;">Hasta:</label>
                                <input type="date" name="fechaFin" id="fechaFin">
                                <span hidden style="color:red;" id="spanFechaFin">Seleccione fecha de fin</span>
                            </div>
                            <div style="display:inline-block;width:23%;">
                                ...
                                <span hidden style="color:red;" id="spanSubd">Seleccione la Subdirección</span>
                            </div>
                            <div style="display:inline-block;width:38%;">
                                <select class="form-select " name="depto" style="display: inline-block;"
                                    id="selectDepto">
                                    <option value="Seleccione" id="seleccione">Seleccione la Subdirección
                                    </option>

                                </select>
                                <span hidden style="color:red;" id="spanDepto">Seleccione el departamento</span>
                            </div>
                    ...
                    <table id="tableHoy" style="width: 100% !important;" hidden>
                        <thead>
                    ...
                    <!----------- TABLE PARA CONSULTAR ASISTENCIAS POR DEPARTAMENTO --------  -->
                    <!-- Tabla de asistencias de todos cert -->

                    <table id="tableFiltro" style="width: 100% !important;">
                        <thead>
                            <tr style="text-align:center;background-color:midnightblue; color:white;">
                                <th>
                                    Fecha
            ...
            <script src="<?=base_url?>assets/js/consultarAsistencias.js"></script>
